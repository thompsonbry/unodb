...
| B2  | Upsert Update — Shared Hotkeys   | Pre-insert 64 hotkeys                       | All threads upsert-update same keys (increment)                                    | test-design B2 |
| B3  | Upsert Erase — Shared Hotkeys    | Pre-insert 64 hotkeys                       | Half threads erase, half update; re-insert erased keys each iteration              | test-design B3 |
